...
const plans = [
  {
    ...
    messages: '2.000',
    limit: 2000,
    features: ['1 agente IA', '2.000 mensagens/mês', 'Suporte por email'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    limit: 5000,
    popular: true,
    features: ['1 agente IA', '5.000 mensagens/mês', 'Suporte prioritário', 'Relatórios'],
  },
  {
    id: 'business',
    name: 'Business',
    ...
    messages: '15.000',
    limit: 15000,
    features: ['1 agente IA', '15.000 mensagens/mês', 'Suporte VIP', 'Relatórios avançados', 'API dedicada'],
  },
];
